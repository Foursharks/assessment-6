...
const drawFive = () => {
  axios.get(`${baseURL}/api/robots/shuffled`).then((res) => {
    //query the api, and make what's returned inside shuffledBots
    const shuffledBots = res.data;
    //console.log(shuffledBots); shuffledBots contains all 10 bots
    //then add the choices to the end of the queue via what's inside shuffledBots
